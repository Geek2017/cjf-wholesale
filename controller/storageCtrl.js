angular.module('cjfw').controller('storageCtrl', function($scope, $timeout) {
    ...
    $scope.savematerial = function() {
        ...
        console.log([$scope.tojson0(obj0).concat($scope.tojson1(obj1))]);
        ...
        var storage = {
            ...
            vendor: $scope.vendor,
            details: [$scope.tojson0(obj0).concat($scope.tojson1(obj1))],
        }
