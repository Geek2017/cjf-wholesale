angular.module('cjfw').controller('storageCtrl', function($scope, $timeout) {
    ...
    $scope.addmaterial = function() {
        $("#addmaterial0").append(' <tr> <td><input type="text" class="form-control" ng-model="ponumber" placeholder="PO Number"></td><td><input type="text" class="form-control" ng-model="odernumber" placeholder="Order Number"></td><td><input type="text" class="form-control" ng-model="sidemark" placeholder="Side Mark"></td><td><input type="text" class="form-control val0" ng-model="width" placeholder="Width"></td><td><input type="text" class="form-control val1" ng-model="length" placeholder="Length"></td><td><input type="text" class="form-control qty" ng-model="quantity" placeholder="Quantity"></td><td><input type="text" class="form-control" ng-model="rollnumber" placeholder="Roll Number"></td></tr>');
